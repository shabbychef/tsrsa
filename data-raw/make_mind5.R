...
mind <- ff_read('5_Industry_Portfolios_TXT',
							 subfile='5_Industry_Portfolios.txt',
							 skip=11,header=FALSE,widths=c(6,rep(7,5)))

colnames(mind) <- gsub('Cnsmr','Consumer',colnames(mind))
